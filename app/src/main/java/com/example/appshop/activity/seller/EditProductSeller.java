...
public class EditProductSeller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        producId = getIntent().getStringExtra("productId");
        mapping();
        onClick();
    ...
    private void loadProductDetails() {
        ...
        reference.child(firebaseAuth.getUid()).child("Products").child(producId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        String discountPrice = "" + snapshot.child("discountedPrice").getValue();
                        ...
                        edtCategory.setText(productCategory);
                        edtDiscountNote.setText(discountNote);
                        ...
                        try {
                            Picasso.get().load(productIcon)
                                    .placeholder(R.drawable.ic_shopping_white).into(iconProduct);
                        }
                        catch (Exception e){
                            iconProduct.setImageResource(R.drawable.ic_shopping_white);
                        }
                    }
    ...
    private void updateProduct() {
        ...
        if(uri == null){
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
            reference.child(firebaseAuth.getUid()).child("Products").child(producId).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            progressDialog.dismiss();
                            Toast.makeText(EditProductSeller.this, "Successful", Toast.LENGTH_SHORT).show();
                        }
                    })
