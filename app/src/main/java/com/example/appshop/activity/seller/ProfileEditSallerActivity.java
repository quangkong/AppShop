...
public class ProfileEditSallerActivity extends AppCompatActivity {

    private EditText edtFullName, edtShopName, edtDeliveryFee, edtPhone, edtAddress;
    private SwitchCompat shopOpenSwich;
    private CircularImageView iconAvt;
    private Button btnEdit;
    private ImageView imgBack;

    private Uri uri = null;
    private String fullName, shopName, deliveryFee, phone, address;
    private boolean shopOpenS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_edit_saller);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot ds : snapshot.getChildren()){
                            ...
                            if(shopOpen.equals("true")){
                                shopOpenSwich.setChecked(true);
                            }
                            else shopOpenSwich.setChecked(false);
                            try {
    ...
    private void inputData() {
        ...
        shopOpenS = shopOpenSwich.isChecked();
        if(fullName.equals("")){
    ...
    private void updateAccount(){
        ...
        if(uri == null){
            ...
            hashMap.put("shopOpen", ""+shopOpenS);
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
            reference.child(firebaseAuth.getUid()).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(ProfileEditSallerActivity.this, "Successful...", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(ProfileEditSallerActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
        else {
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if(uriTask.isSuccessful()){
                                ...
                                hashMap.put("address", ""+address);
                                hashMap.put("shopOpen", ""+shopOpenS);
                                hashMap.put("profileImage", ""+dowloadImageUri);
                                DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
                                reference.child(firebaseAuth.getUid()).updateChildren(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
    ...
    private void mapping() {
        ...
        shopOpenSwich = findViewById(R.id.shopOpenSwich);
